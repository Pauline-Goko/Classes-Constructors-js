...
let newCar = new Car("Toyota", "Camry", 2019, true);
console.log({newCar});
...
class Rental {
  ...
  let myCar = new Car("BMW", "X5", 2017, );
  let myRental = new Rental(myCar, "Pauline", "2023-05-05", "2023-05-20");
...
// Then, create an instance of the Rental class or function constructor for
// a rental involving the car you created. Finally, calculate the rental duration using
// the calculateRentalDuration method.

const dreamCar = new Car("Audi", "A4", 2022, false);
const rent = new Rental(dreamCar, "Wanjiru", "2023-05-05", "2023-05-29");
...
// individual questions, and the Quiz class will manage a collection of questions and the user's progress.
...
const userAnswer = "skin";
const checkUserAnswer = question.checkAnswer(userAnswer);
...
class Quiz {
    ...
    submitAnswer(userAnswer) {
      ...
      const checkUserAnswer2 = currentQuestion.checkAnswer(userAnswer);
      if (checkUserAnswer2) {
        this.score++;
      }
    }
